				...
				<div class="row"> 
					<div class="col-lg-8 col-12">
						<div class="checkout-form">
							...
							<!-- Form -->
							<form class="form" method="POST" action="DangNhapTaiKhoanController">
								<div class="row">
									...
									<div class="col-12">
										<div class="form-group create-account">
											<a href="DangKyTaiKhoanController" style="font-size: 20px">If you do not already have an account ?</a>
										</div>
									</div>
								</div>
								<!-- Button Widget -->
